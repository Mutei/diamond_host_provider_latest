...
//         if (estateData['IsAccepted'] == "2" && estateData['Type'] == "3") {
//           estateList.add({
//             'id': estateID,
...
//     return Scaffold(
//       appBar: ReusedAppBar(
//         title: getTranslated(context, "My Restaurants"),
//       ),
//       body: isLoading
...
//               ? Center(
//                   child: Text(
//                     getTranslated(context, "You have not added any hotels yet"),
...
//                         //         child: Text(getTranslated(context, "Hotel")),
//                         //       ),
//                         //       ElevatedButton(
//                         //         onPressed: () => _filterByCategory("2"),
//                         //         child: Text(getTranslated(context, "Coffee")),
//                         //       ),
//                         //       ElevatedButton(
//                         //         onPressed: () => _filterByCategory("3"),
//                         //         child:
...
//                                 : getTranslated(context, "My Restaurants"),
//                             style: kPrimaryStyle.copyWith(fontSize: 22),
//                           ),
//                         ),
